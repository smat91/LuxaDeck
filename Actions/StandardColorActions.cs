...
namespace LuxaDeck
{
    [PluginActionId("com.smat91.luxadeck.standardcolors.keyaction")]
    public class StandardColorActions : KeypadBase
    {
        ...
        public StandardColorActions(ISDConnection connection, InitialPayload payload) : base(connection, payload)
        {
